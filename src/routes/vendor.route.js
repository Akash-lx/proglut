...
router.route("/vendor/detail").get(getVendorDetail).patch(vendorUpload.single("profileImage"),updateVendorDetail)
...
router.route("/user/detail").get(getVendorDetail).patch(vendorUpload.single("profileImage"),updateVendorDetail)
